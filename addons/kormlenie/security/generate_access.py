...
spisok.append(['korm.racion_pit_line',''])
...
spisok.append(['korm.analiz_smes_korma',''])
spisok.append(['korm.analiz_smes_korma_line',''])
spisok.append(['korm.analiz_smes_korma_svod_line',''])
